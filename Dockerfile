...
COPY landing_page.html customers.html work.html Educare.html hz_labs_logo_futuristic.svg shutafimlamasa-og.png streaming-platform.png og-image.png favicon-32x32.png favicon-16x16.png /usr/share/nginx/html/
